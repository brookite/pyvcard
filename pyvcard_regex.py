...
VALID_TZ = re.compile(r"(Z|([+-])?(\d{1,2}):?(\d{2}))")
...
VALID_DATETIME = re.compile(r"^({})?T?({})?$".format(VALID_DATE.pattern, VALID_TIME.pattern))
VALID_TIMESTAMP = re.compile(r"^{}T{}$".format(VALID_DATE.pattern, VALID_TIME.pattern))
